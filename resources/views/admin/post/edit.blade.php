    ...
    <div class="row">
        <div class="card col-10">
            ...
            <div class="card-body">
                ...
                @endif
                <form action="{{ route('admin.posts.update',$post->id) }}" id="form" method="POST"
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="form-group">
                                ...
                                <input onkeyup="ChangeToSlug();" id="input-tittle" value="{{ $post->tittle }}"
                    ...
                    <div class="row">
                        <div class="col-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="slug" value="{{ $post->slug }}" id="input-slug"
                        ...
                        <div class="col-6">
                            <div class="row">
                                ...
                                <div class="col-5">
                                    ...
                                    <img src="{{ asset('public/uploads/posts/' . $post->thumbnail . '') }}" height="80" alt="thumbnail">
                                </div>
                                <div class="col-7">
                    ...
                    <div class="row">
                        <div class="col-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="tags" value="{{ $post->tags }}" id="input-tags"
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="form-group">
                                ...
                                <textarea name="content" id="ckeditor-content" cols="70" rows="10">{{ $post->content }}</textarea>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-4">
                            <button type="submit" id="btn-update-post" class="btn btn-primary">Lưu Thay Đổi</button>
                        </div>
                    </div>
