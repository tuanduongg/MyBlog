...
<head>
    ...
    <!-- CSS Files -->
    <link href="{{ asset('admin/assets/css/black-dashboard.css_v=1.0.0.css') }}" rel="stylesheet" />
    @stack('css')
</head>
...
<body class="">
    ...
    <!-- Chart JS -->
    <script src="{{ asset('admin/assets/js/chartjs.min.js') }}"></script>
    ...
    <script type="text/javascript" src="https://cdnjs.cloudflare.com/ajax/libs/typeahead.js/0.11.1/bloodhound.js"></script>
    {{-- ckeditor --}}
