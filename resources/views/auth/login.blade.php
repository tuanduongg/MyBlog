...
<body>
    <div class="login-container">
        ...
        <form action="" method="POST" class="form-login">
            ...
            <input id="login-input-user" name="email" value="{{ old('email') ?? 'admin@gmail.com' }}" class="login__input"
                type="text" />
            <label for="login-input-password" class="login__label">
                Mật khẩu
            </label>
            <input id="login-input-password" value="{{ old('password') ?? '114' }}" name="password"
                class="login__input" type="password" />
            <label for="login-sign-up" class="login__label--checkbox">
                <input id="login-sign-up" checked name="remember" type="checkbox" class="login__input--checkbox" />
                Ghi nhớ đăng nhập
            </label>
